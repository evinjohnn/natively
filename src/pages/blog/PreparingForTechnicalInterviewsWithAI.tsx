...
export default function PreparingForTechnicalInterviewsWithAI() {
  return (
    <SEOTemplate
      ...
      ru={{ title: "Подготовка к техническим собеседованиям с ИИ | Полное руководство", description: "Узнайте, как подготовиться к техническим собеседованиям с помощью ИИ-ассистентов. Используйте оффлайн-алгоритмы для практики системного дизайна и LeetCode." }}
